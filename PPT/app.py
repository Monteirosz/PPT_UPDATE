...
def jogo():
    ...
    if request.method == 'POST':
        ...
        if 'ver_resultado' in request.form and jogador1_escolha and jogador2_escolha:
            ...
            if jogador1_escolha == jogador2_escolha:
                ...
                session['resultado'] = "Jogador 1 venceu!"
                session['placar1'] += 1              
            else:
                session['resultado'] = "Jogador 2 venceu!"
                session['placar2'] += 1
    ...
    return render_template("index.html", res=session['resultado'], jogador1_escolha=session.get('jogador1_escolha'), jogador2_escolha=session.get('jogador2_escolha'), placar1=session['placar1'], placar2=session['placar2'])
